...
import 'package:bhej/configs/darkTheme.dart';
import 'package:bhej/configs/lightTheme.dart';
import 'package:bhej/ui/Inbox/inboxpage.dart';
import 'package:bhej/ui/Login/login.dart';
import 'package:bhej/ui/SplashActivity.dart';
  ...
  Widget build(BuildContext context) {
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
     // systemNavigationBarColor: Color(0xff000000), // navigation bar color
      statusBarColor: ColorResource.toolbar_color, // status bar color
    ));
